...
\begin{figure}[H]
\centering
\includegraphics[width=.49\textwidth,height=0.3\textwidth]{figures/31.eps}
\includegraphics[width=.49\textwidth,height=0.3\textwidth]{figures/32.eps}
\includegraphics[width=.49\textwidth,height=0.3\textwidth]{figures/33.eps}
\includegraphics[width=.49\textwidth,height=0.3\textwidth]{figures/34.eps}
\caption{测试集$ROC$曲线}
\end{figure}
